...
<head>
  ...
  <script nonce="cd536a75-82d6-4423-821c-1f1609cb6a8b">
    (function(w, d) {
  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        <p class="mb-1">
          <a href="<?= route_to('user.forgotpass'); ?>">Forgot my password</a>
        </p>
        <p class="mb-0">
          <a href="<?= route_to('user.register'); ?>" class="text-center">Don't have account. Register here</a>
        </p>
      </div>
