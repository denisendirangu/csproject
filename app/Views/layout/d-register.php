...
<div class="input-group mb-3">
<input type="password" required name="c_password" class="form-control" placeholder="Retype password">
<div class="input-group-append">
<div class="input-group-text">
<span class="fas fa-lock"></span>
</div>
...
<a href="<?= route_to('user.login'); ?>" class="text-center">I already have an account</a>
</div>
